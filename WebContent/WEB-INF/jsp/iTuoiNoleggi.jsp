...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <form action="NuovoNoleggioServlet" method="GET">	
	 ...
	 <form action="ITuoiNoleggiServlet" method="GET">	
   	        	<button type="submit" class="w3-bar-item w3-button w3-padding w3-blue" ><i class="fa fa-users fa-fw"></i> I tuoi noleggi</button>				
...
<div class="row">	  
	  <%
	  	List<Noleggio> list = (List<Noleggio>)request.getAttribute("noleggiUtente");
	  if(!list.isEmpty()){
	  %>
  ...
  <tbody>	  	  	
    ...
    <%
 		...
 		for(Noleggio n : list ){
			...
			Date dataI =n.getDataInizio();
			Date dataF =n.getDataFine();
			
			SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
			
		    String dataInizio = formatter.format(dataI);  
		    String dataFine = formatter.format(dataF);  

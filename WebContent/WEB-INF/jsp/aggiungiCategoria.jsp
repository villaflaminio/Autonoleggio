...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <form action="CategorieServlet" method="GET">	
   	        	<button type="submit" class="w3-bar-item w3-button w3-padding " ><i class="fa fa-users fa-fw"></i>Categorie</button>				
			    	    
	</form>
	 <form action="CategorieServlet" method="POST">	
   	        	<button type="submit" class="w3-bar-item w3-button w3-padding w3-blue" ><i class="fa fa-users fa-fw"></i>Aggiungi categoria</button>				
